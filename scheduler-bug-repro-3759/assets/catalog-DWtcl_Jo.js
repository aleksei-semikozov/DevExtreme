import { j as jQuery, _ as __vitePreload, s as setLicenseCheckSkipCondition } from './preload-helper-C7ManULh.js';
...
const themeLoaders = /* #__PURE__ */ Object.assign({"../artifacts/css/dx.carmine.compact.css": () => __vitePreload(() => import('./dx.carmine.compact-BNkHiX0w.js'),true              ?[]:void 0,import.meta.url).then(m => m["default"]),"../artifacts/css/dx.carmine.css": () => __vitePreload(() => import('./dx.carmine-BdvQ42hD.js'),true              ?[]:void 0,import.meta.url).then(m => m["default"]),"../artifacts/css/dx.common.css": () => __vitePreload(() => import('./dx.common-Cph7l5t5.js'),true              ?[]:void 0,import.meta.url).then(m => m["default"]),"../artifacts/css/dx.contrast.compact.css": () => __vitePreload(() => import('./dx.contrast.compact-ETr_fEvI.js'),true              ?[]:void 0,import.meta.url).then(m => m["default"]),"../artifacts/css/dx.contrast.css": () => __vitePreload(() => import('./dx.contrast-wkBb1iju.js'),true              ?[]:void 0,import.meta.url).then(m => m["default"]),"../artifacts/css/dx.dark.compact.css": () => __vitePreload(() => import('./dx.dark.compact-oBNQoXQT.js'),true              ?[]:void 0,import.meta.url).then(m => m["default"]),"../artifacts/css/dx.dark.css": () => __vitePreload(() => import('./dx.dark-Qsv9R5kU.js'),true              ?[]:void 0,import.meta.url).then(m => m["default"]),"../artifacts/css/dx.darkmoon.compact.css": () => __vitePreload(() => import('./dx.darkmoon.compact-BdrPmUD4.js'),true              ?[]:void 0,import.meta.url).then(m => m["default"]),"../artifacts/css/dx.darkmoon.css": () => __vitePreload(() => import('./dx.darkmoon-Cdyi9Nix.js'),true              ?[]:void 0,import.meta.url).then(m => m["default"]),"../artifacts/css/dx.darkviolet.compact.css": () => __vitePreload(() => import('./dx.darkviolet.compact-Bubl9QTn.js'),true              ?[]:void 0,import.meta.url).then(m => m["default"]),"../artifacts/css/dx.darkviolet.css": () => __vitePreload(() => import('./dx.darkviolet-BJ2F_Yb4.js'),true              ?[]:void 0,import.meta.url).then(m => m["default"]),"../artifacts/css/dx.fluent.blue.dark.compact.css": () => __vitePreload(() => import('./dx.fluent.blue.dark.compact-DiOpKOZ1.js'),true              ?[]:void 0,import.meta.url).then(m => m["default"]),"../artifacts/css/dx.fluent.blue.dark.css": () => __vitePreload(() => import('./dx.fluent.blue.dark-BGvYbvfi.js'),true              ?[]:void 0,import.meta.url).then(m => m["default"]),"../artifacts/css/dx.fluent.blue.light.compact.css": () => __vitePreload(() => import('./dx.fluent.blue.light.compact-CdllWvDA.js'),true              ?[]:void 0,import.meta.url).then(m => m["default"]),"../artifacts/css/dx.fluent.blue.light.css": () => __vitePreload(() => import('./dx.fluent.blue.light-ByCgECDz.js'),true              ?[]:void 0,import.meta.url).then(m => m["default"]),"../artifacts/css/dx.fluent.saas.dark.compact.css": () => __vitePreload(() => import('./dx.fluent.saas.dark.compact-BCdjMxgj.js'),true              ?[]:void 0,import.meta.url).then(m => m["default"]),"../artifacts/css/dx.fluent.saas.dark.css": () => __vitePreload(() => import('./dx.fluent.saas.dark-D91ysmxO.js'),true              ?[]:void 0,import.meta.url).then(m => m["default"]),"../artifacts/css/dx.fluent.saas.light.compact.css": () => __vitePreload(() => import('./dx.fluent.saas.light.compact-Bex7Iel1.js'),true              ?[]:void 0,import.meta.url).then(m => m["default"]),"../artifacts/css/dx.fluent.saas.light.css": () => __vitePreload(() => import('./dx.fluent.saas.light-DrRjzG6m.js'),true              ?[]:void 0,import.meta.url).then(m => m["default"]),"../artifacts/css/dx.greenmist.compact.css": () => __vitePreload(() => import('./dx.greenmist.compact-C2gbngNz.js'),true              ?[]:void 0,import.meta.url).then(m => m["default"]),"../artifacts/css/dx.greenmist.css": () => __vitePreload(() => import('./dx.greenmist-CjNRAdyp.js'),true              ?[]:void 0,import.meta.url).then(m => m["default"]),"../artifacts/css/dx.light.compact.css": () => __vitePreload(() => import('./dx.light.compact-DDn9-H87.js'),true              ?[]:void 0,import.meta.url).then(m => m["default"]),"../artifacts/css/dx.light.css": () => __vitePreload(() => import('./dx.light-Ci8jJWdx.js'),true              ?[]:void 0,import.meta.url).then(m => m["default"]),"../artifacts/css/dx.material.blue.dark.compact.css": () => __vitePreload(() => import('./dx.material.blue.dark.compact-BrsV5jGa.js'),true              ?[]:void 0,import.meta.url).then(m => m["default"]),"../artifacts/css/dx.material.blue.dark.css": () => __vitePreload(() => import('./dx.material.blue.dark-7edB5GAU.js'),true              ?[]:void 0,import.meta.url).then(m => m["default"]),"../artifacts/css/dx.material.blue.light.compact.css": () => __vitePreload(() => import('./dx.material.blue.light.compact-D2rzZR9Z.js'),true              ?[]:void 0,import.meta.url).then(m => m["default"]),"../artifacts/css/dx.material.blue.light.css": () => __vitePreload(() => import('./dx.material.blue.light-BfG2gZGs.js'),true              ?[]:void 0,import.meta.url).then(m => m["default"]),"../artifacts/css/dx.material.lime.dark.compact.css": () => __vitePreload(() => import('./dx.material.lime.dark.compact-Du0EdXzM.js'),true              ?[]:void 0,import.meta.url).then(m => m["default"]),"../artifacts/css/dx.material.lime.dark.css": () => __vitePreload(() => import('./dx.material.lime.dark-CGkkrfPJ.js'),true              ?[]:void 0,import.meta.url).then(m => m["default"]),"../artifacts/css/dx.material.lime.light.compact.css": () => __vitePreload(() => import('./dx.material.lime.light.compact-Cdi0UMoJ.js'),true              ?[]:void 0,import.meta.url).then(m => m["default"]),"../artifacts/css/dx.material.lime.light.css": () => __vitePreload(() => import('./dx.material.lime.light-YUgHPsmp.js'),true              ?[]:void 0,import.meta.url).then(m => m["default"]),"../artifacts/css/dx.material.orange.dark.compact.css": () => __vitePreload(() => import('./dx.material.orange.dark.compact-BmsZxDgE.js'),true              ?[]:void 0,import.meta.url).then(m => m["default"]),"../artifacts/css/dx.material.orange.dark.css": () => __vitePreload(() => import('./dx.material.orange.dark-Bfy0TEG2.js'),true              ?[]:void 0,import.meta.url).then(m => m["default"]),"../artifacts/css/dx.material.orange.light.compact.css": () => __vitePreload(() => import('./dx.material.orange.light.compact--5hhJYG_.js'),true              ?[]:void 0,import.meta.url).then(m => m["default"]),"../artifacts/css/dx.material.orange.light.css": () => __vitePreload(() => import('./dx.material.orange.light-CAol7gsv.js'),true              ?[]:void 0,import.meta.url).then(m => m["default"]),"../artifacts/css/dx.material.purple.dark.compact.css": () => __vitePreload(() => import('./dx.material.purple.dark.compact-DivS7U7C.js'),true              ?[]:void 0,import.meta.url).then(m => m["default"]),"../artifacts/css/dx.material.purple.dark.css": () => __vitePreload(() => import('./dx.material.purple.dark-BSlBKdjL.js'),true              ?[]:void 0,import.meta.url).then(m => m["default"]),"../artifacts/css/dx.material.purple.light.compact.css": () => __vitePreload(() => import('./dx.material.purple.light.compact-MvqX4Uvu.js'),true              ?[]:void 0,import.meta.url).then(m => m["default"]),"../artifacts/css/dx.material.purple.light.css": () => __vitePreload(() => import('./dx.material.purple.light-CWu0kkf3.js'),true              ?[]:void 0,import.meta.url).then(m => m["default"]),"../artifacts/css/dx.material.teal.dark.compact.css": () => __vitePreload(() => import('./dx.material.teal.dark.compact-BhBEG1Hx.js'),true              ?[]:void 0,import.meta.url).then(m => m["default"]),"../artifacts/css/dx.material.teal.dark.css": () => __vitePreload(() => import('./dx.material.teal.dark-BJ5fnXWL.js'),true              ?[]:void 0,import.meta.url).then(m => m["default"]),"../artifacts/css/dx.material.teal.light.compact.css": () => __vitePreload(() => import('./dx.material.teal.light.compact-Cpghxf8w.js'),true              ?[]:void 0,import.meta.url).then(m => m["default"]),"../artifacts/css/dx.material.teal.light.css": () => __vitePreload(() => import('./dx.material.teal.light-BXYvi7xw.js'),true              ?[]:void 0,import.meta.url).then(m => m["default"]),"../artifacts/css/dx.softblue.compact.css": () => __vitePreload(() => import('./dx.softblue.compact-BcYdikxG.js'),true              ?[]:void 0,import.meta.url).then(m => m["default"]),"../artifacts/css/dx.softblue.css": () => __vitePreload(() => import('./dx.softblue-DyRGqF0r.js'),true              ?[]:void 0,import.meta.url).then(m => m["default"])
...
function buildNav(filter) {
  ...
  widgetGroups.forEach(group => {
    const matching = group.ids.filter(id => {
      ...
      const demoMatches = (demosMap[getWidgetName(id)] ?? []).some(d => d.title.toLowerCase().includes(lc) || d.name.toLowerCase().includes(lc));
    ...
    matching.forEach(id => {
      ...
      jQuery('<a>').attr('href', `#${id}`).text(registry[id].label).toggleClass('active', id === currentHash).appendTo($li);
      ...
      if (lc) {
        ...
        const widgetMatches = registry[id].label.toLowerCase().includes(lc) || id.toLowerCase().includes(lc);
        const matchingDemos = (demosMap[widgetName] ?? []).filter(d => d.title.toLowerCase().includes(lc) || d.name.toLowerCase().includes(lc));
        if (!widgetMatches && matchingDemos.length > 0) {
          const $demos = jQuery('<ul class="demo-search-results">').appendTo($li);
          matchingDemos.forEach(d => {
            const hash = `demo/${widgetName}/${d.name}`;
            jQuery('<li>').append(jQuery('<a class="demo-search-link">').attr('href', `#${hash}`).toggleClass('active', currentHash === hash).text(d.title)).appendTo($demos);
          });
        }
      }
    });
