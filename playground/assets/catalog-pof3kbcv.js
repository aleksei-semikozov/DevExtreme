import { j as jQuery, _ as __vitePreload, s as setLicenseCheckSkipCondition } from './preload-helper-DlyJteKQ.js';
...
function setupThemeSelector(selectorId) {
  return new Promise(resolve => {
    ...
    const defaultTheme = themeList.find(t => t === 'fluent.blue.light') || themeList[0];
